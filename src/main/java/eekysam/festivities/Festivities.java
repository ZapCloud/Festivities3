...
public class Festivities
{
	...
	public void preInit(FMLPreInitializationEvent event)
	{
		...
		snowglobe = new BlockSnowGlobe(Material.glass).setCreativeTab(Festivities.decorTab).setBlockName("snowglobe").setBlockTextureName(Festivities.ID + ":snowglobe");
		this.registerBlock(snowglobe, "snowglobe");
		GameRegistry.registerTileEntity(TileEntitySnowglobe.class, "snowglobe");
		
		treatplate = new BlockTreatPlate(Material.glass).setCreativeTab(Festivities.blockTab).setBlockName("treatplate").setBlockTextureName(Festivities.ID + ":treatplate");
		...
		fireplace = new BlockFireplace(Material.rock).setBlockName("fireplace").setBlockTextureName(Festivities.ID + ":fireplace").setLightLevel(1.0F).setCreativeTab(Festivities.blockTab);
		...
		snowMachine = new BlockSnowMachine(Material.rock).setBlockName("snowMachine").setBlockTextureName(Festivities.ID + ":snowMachine").setCreativeTab(Festivities.blockTab);
		...
		garlandBlock = new BlockGarland(Material.circuits).setBlockName("garlandBlock").setBlockTextureName(Festivities.ID + ":garland");
		...
		mintLeaf = new ItemMintPlant().setTip("Green and Minty!").setShiftTip("Right-Click to place").setUnlocalizedName("mintLeaf").setTextureName(Festivities.ID + ":mintLeaf").setCreativeTab(Festivities.miscTab);
		this.registerItem(mintLeaf, "mintLeaf");

		mintPlant = new BlockMintPlant().setBlockName("mintPlant").setBlockTextureName(Festivities.ID + ":mintPlant");
