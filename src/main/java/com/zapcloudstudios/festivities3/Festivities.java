...
public class Festivities
{
	...
	public void preInit(FMLPreInitializationEvent event)
	{
		...
		this.registerBlockWithoutItem(clearOrnamentBlock, "clearOrnamentBlock");

		coloredOrnamentBlock = new BlockOrnament(false).setBlockName("coloredOrnamentBlock");
		this.registerBlockWithoutItem(coloredOrnamentBlock, "coloredOrnamentBlock");
		...
		this.registerBlockWithoutItem(garlandBlock, "garlandBlock");
